...
public class Emp_database {
	...
	public static void main(String[] args) throws Exception {
		...
		Connection con = DriverManager
				.getConnection(db_url, db_uname, db_upass);
		while (true) {
			...
			case 5:
				...
				System.out
						.print("Enter Employee number to update  salary  :");
				int no = sc.nextInt();
			...
			case 6:
				...
				break;
			case 7:
				System.out.println("Enter Id to fetch salary :");
				int id1 = sc.nextInt();

				CallableStatement stmt2 = con
						.prepareCall("{?=call return_sal(?)}");
